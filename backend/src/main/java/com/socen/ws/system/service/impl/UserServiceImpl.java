...
import com.socen.ws.system.dao.UserRoleMapper;
...
import com.socen.ws.system.service.UserRoleService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public IPage<User> findUserDetail(User user, QueryRequest request) {
        try {
            ...
            SortUtil.handlePageSort(request, page, "userId", WsConstant.ORDER_ASC, false);
