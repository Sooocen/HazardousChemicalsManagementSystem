package com.socen.ws.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/ws?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    // @author 值
    private static final String AUTHOR = "Socen";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.socen.ws";
    // xml文件路径
    ...
    public static void main(String[] args) {
        ...
        strategy.setSuperControllerClass("com.socen.ws.common.controller.BaseController");
